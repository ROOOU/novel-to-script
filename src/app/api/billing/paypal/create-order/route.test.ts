...
describe('billing create order api route', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it('returns platform headers on successful checkout creation', async () => {
    const { POST } = await import('@/app/api/billing/paypal/create-order/route');
