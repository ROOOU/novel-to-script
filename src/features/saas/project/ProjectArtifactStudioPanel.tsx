      ...
      <div className="version-layout">
        ...
        {selectedArtifact ? (
          ...
          <div className="artifact-block stack-gap">
            ...
            <div className="artifact-meta-grid">
              <div className="skeleton-loader" style={{ height: '64px' }} />
              <div className="skeleton-loader" style={{ height: '64px' }} />
              <div className="skeleton-loader" style={{ height: '64px' }} />
              <div className="skeleton-loader" style={{ height: '64px' }} />
            </div>
            <div className="skeleton-loader" style={{ height: '240px', width: '100%' }} />
            <p className="helper-text align-center">AI 正在努力为您创作和打磨当前的内容节点，请稍候...</p>
          </div>
        ) : (
          <div className="artifact-block empty-state stack-gap" style={{ textAlign: 'center', padding: '48px 24px' }}>
            <div style={{ fontSize: '48px', opacity: 0.5 }}>📝</div>
            <h3>等待内容生成</h3>
            <p className="helper-text">{labels.noArtifacts}</p>
          </div>
        )}
      </div>
    </article>
